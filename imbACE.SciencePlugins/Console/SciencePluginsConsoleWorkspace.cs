...
namespace imbACE.SciencePlugins.Console
{
    ...
    /// <summary>
    /// Workspace holds reference to dedicated directory of the console
    /// </summary>
    /// <seealso cref="imbACE.Services.console.aceAdvancedConsoleWorkspace" />
    public class SciencePluginsConsoleWorkspace : aceAdvancedConsoleWorkspace
    {


        /// <summary>
        /// Initializes the workspace for the SciencePluginsConsole console 
        /// </summary>
        /// <param name="console">The console using this workspace</param>
        public SciencePluginsConsoleWorkspace(SciencePluginsConsoleConsole console):base(console)
        {
