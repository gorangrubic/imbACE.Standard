...
namespace $safeprojectname$.console
{
    ...
    public class $safeprojectname$Workspace : aceAdvancedConsoleWorkspace
    {


        /// <summary>
        /// Initializes the workspace for the $safeprojectname$ console 
        /// </summary>
        /// <param name="console">The console using this workspace</param>
        public $safeprojectname$Workspace($safeprojectname$Console console):base(console)
        {
