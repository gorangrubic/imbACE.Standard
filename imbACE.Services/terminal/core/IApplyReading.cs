// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IApplyReading.cs" company="imbVeles" >
//
...
namespace imbACE.Services.terminal.core
{
    ...
    public interface IApplyReading
    {
        textInputResult applyReading(IPlatform platform, textInputResult __currentOutput);
    }
}