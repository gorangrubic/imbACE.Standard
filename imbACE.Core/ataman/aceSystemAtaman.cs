// --------------------------------------------------------------------------------------------------------------------
// <copyright file="aceSystemAtaman.cs" company="imbVeles" >
//
...
namespace imbACE.Core.ataman
{
    ...
    /// </summary>
    public class aceSystemAtaman
    {
        public aceSystemAtaman()
        {
        }
        ...
        /// </summary>
        internal static Boolean doPauseAllFileWatchers = false;

        /// <summary>
        /// U milisekundama koliko zadrzava event listu pre nego sto prijavi event
        /// </summary>
        internal static Int32 defaultEventsFlushInterval = 2500;
    }
}