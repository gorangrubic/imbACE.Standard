// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IAceCommand.cs" company="imbVeles" >
//
...
namespace imbACE.Core.commands.expressions
{
    ...
    /// <summary>
    /// Expression command ACE subsystem
    /// </summary>
    public interface IAceCommand
    {
        /// <summary>
...
// [XmlIgnore]
        ...
        String commandShortName { get; set; }
...
// [XmlIgnore]
        ...
        String commandFullname { get; set; }
...
// [XmlIgnore]
        ...
        event aceCommandEvent onCommandCalled;

        void callCommand(aceCommandEventArgs _args);
    }
}