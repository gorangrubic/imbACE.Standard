// --------------------------------------------------------------------------------------------------------------------
// <copyright file="aceOperationSetExecutorBase.cs" company="imbVeles" >
//
...
namespace imbACE.Core.operations
{
    ...
    /// </summary>
    public abstract class aceOperationSetExecutorBase : aceBindable
    {
        // public abstract aceMenu commands { get; }
        // public abstract String consoleTitle { get; }
        // public abstract String consoleHelp { get; }
        // public abstract ILogBuilder output { get; set; }
    }
}