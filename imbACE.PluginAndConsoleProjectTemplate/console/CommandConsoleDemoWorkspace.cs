...
namespace $rootnamespace$.console
{
    ...
    public class $fileinputname$Workspace : aceAdvancedConsoleWorkspace
    {


        /// <summary>
        /// Initializes the workspace for the $fileinputname$ console 
        /// </summary>
        /// <param name="console">The console using this workspace</param>
        public $fileinputname$Workspace($fileinputname$Console console):base(console)
        {
