// --------------------------------------------------------------------------------------------------------------------
// <copyright file="aceRemoteInstanceBaseEvent.cs" company="imbVeles" >
//
...
namespace imbACE.Network.remote.events
{
    ...
    public delegate void aceRemoteInstanceBaseEvent(aceRemoteInstanceBase sender, aceRemoteInstanceBaseEventArgs args);
}