// --------------------------------------------------------------------------------------------------------------------
// <copyright file="aceRemoteInstanceBase.cs" company="imbVeles" >
//
...
namespace imbACE.Network.remote.instance
{
    ...
    public abstract class aceRemoteInstanceBase : aceComponentBase<aceRemoteSettings>
    {
        ...
        {
            log("Buffersize: " + settings.bufferSize.ToString());
            log("Server hostname: " + settings.serverIP);
            log("Server port: " + settings.serverPort);
        }
    }
}