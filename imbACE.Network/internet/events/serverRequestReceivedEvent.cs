// --------------------------------------------------------------------------------------------------------------------
// <copyright file="serverRequestReceivedEvent.cs" company="imbVeles" >
//
...
namespace imbACE.Network.internet.events
{
    ...
    public delegate void serverRequestReceivedEvent(IAceHttpServer sender, serverRequestReceivedEventArgs args);
}